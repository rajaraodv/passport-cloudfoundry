...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || 'https://uaa.cloudfoundry.com/oauth/authorize';
    options.tokenURL = options.tokenURL || 'https://uaa.cloudfoundry.com/oauth/token';
